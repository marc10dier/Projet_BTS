...
const CartPage = () => {
    ...
    const emptyCartMsg = <h4 className='text-red fw-6'>Votre panier est vide, veuillez-vous rendre à la boutique!</h4>;
        ...
        <div className='bg-ghost-white py-5'>
            <div className='container'>
                <div className='section-title bg-ghost-white'>
                    <h3 className = "text-uppercase fw-7 text-regal-blue ls-1">Mon panier</h3>
                </div>
                {
                                            ...
                                            <div className='cart-item grid' key = {cartProduct.id}>
                                                ...
                                                <div className='cart-item-info'>
                                                    ...
                                                    <div className = "qty flex">
                                                        <span className = "text-light-blue qty-text">Quantité: </span>
                                                    ...
                                                    <div className = "flex flex-between">
                                                        <div className='text-pine-green fw-4 fs-15 price'>Prix : {formatPrice(cartProduct.price)}.00</div>
                            ...
                            <div className='cart-right bg-white'>
                                <div className = 'cart-summary text-light-blue'>
                                    ...
                                    <div className='cart-summary-btn'>
                                        <button type = "button" className='btn-secondary'>Poursuivre le paiement</button>
                                    </div>
                                </div>
                            </div>
                        </div>
